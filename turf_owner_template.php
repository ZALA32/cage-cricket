<?php
// turf_owner_template.php - Unified Layout with Restored Old UI/UX
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center gap-2" href="turf_owner_dashboard.php">
            <img src="images/cage-cricket-logo.png" alt="Logo" width="40" height="40">
...
<!-- MAIN CONTENT -->
<main class="main-content flex-grow-1 fade-in">
    <?php
